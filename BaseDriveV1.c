...
#pragma config(Motor,  port4,           leftWheel3,    tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           rightWheel3,    tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,          topShooter,   tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port7,          bottomShooter,   tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port8,          intake,   tmotorVex393_HBridge, openLoop)
